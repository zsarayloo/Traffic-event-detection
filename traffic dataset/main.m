...
Vid=VideoReader('vid (1).mpg');%select video

pixel=100; % minimum pixel of object

obj = setupSystemObjects(pixel);
...
%             'MinimumBlobArea',200);
% [Area, centroids, bboxes,Lable] = blobAnalyser.step(mask);
...
%% write video
writerObj=VideoWriter('vid (1).mpg.label');
